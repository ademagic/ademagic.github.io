...
output += "\n  <nav class=\"nav\">\n    <ul class=\"[ nav__list ] [ nav__list--footer ] [ box-flex align-center ]\">\n      ";
var tasks = [];
tasks.push(
function(callback) {
...
var parentTemplate = null;
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "navigation")),"items")) {
output += "\n  <nav class=\"nav\">\n    <ul class=\"[ nav__list ] [ box-flex align-center md:space-before text-400 ]\">\n      ";
var tasks = [];
tasks.push(
function(callback) {
...
tasks.push(
function(callback) {
env.getTemplate("partials/components/nav-foot.njk", false, "partials/global/site-foot.njk", false, function(t_2,t_1) {
if(t_2) { cb(t_2); return; }
callback(null,t_1);});
});
tasks.push(
...
output += "</span>\n        <span class=\"[ site-head__site-name ] [ text-400 ]\" aria-hidden=\"true\">";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "site")),"name"), env.opts.autoescape);
output += "</span>\n      </a>\n      ";
var tasks = [];
tasks.push(
